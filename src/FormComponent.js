  ...
  return (
    <main>
      ...
      <form className="inputForm">
        ...
        <br />
        <label className="destination-header"><h5>Select your destination:</h5></label>
        <br />
        <select
        ...
        >
          ...
          <option value="Thailand">Etas-unis</option>
          <option value="Japan">Japan</option>
          <option value="Brazil">Canada</option>
        </select>
        <br />
        <br />
        <label className="restrictions-title"><h5>Dietary restrictions:</h5></label>
        <br />
